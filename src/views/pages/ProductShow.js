...
let ProductShow = {
    ...
    , after_render: async () => {
        ...
        tippy('.productShowEmbedded', {
            content: '<div class="gremTitle">EMBEDDED STRING</div> All strings on this page are embedded in source code. <a href="https://github.com/Lingoport/Rebel-Outfitters/blob/DarkSide/src/content/products.js" target="_blank">View Source</a> <a href="https://wiki.lingoport.com/Gremlins#Embedded_Strings" target="_blank">View Details</a>',
            theme: 'custom',
            arrow: true,
            interactive: true
        });
